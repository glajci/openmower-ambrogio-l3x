...
class App:
    def __init__(self):
        ...
        self.buttonUp = Button(25, pull_up=True)
        self.buttonDown = Button(8, pull_up=True)
        self.buttonEnter = Button(7, pull_up=True)
        self.buttonDock = Button(1, pull_up=False)
        self.buttonPlay = Button(12, pull_up=False)
